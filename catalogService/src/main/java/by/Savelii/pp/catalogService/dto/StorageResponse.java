...
public class StorageResponse {
    ...
    public StorageResponse(Long id, String brand, String model, String type, int capacity, String storageInterface, String formFactor, int maxReadSpeed, int maxWriteSpeed, int tdp, BigDecimal price, String currency, boolean stockAvailable, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
        this.id = id;
        this.brand = brand;
        this.model = model;
        this.type = type;
