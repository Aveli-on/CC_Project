...
public class MotherboardResponse {
    ...
    public MotherboardResponse() {
    }

    public MotherboardResponse(Long id, String brand, String model, String socket, String chipset, String formFactor, String memoryType, int maxMemorySpeed, int maxMemoryCapacity, int memorySlots, boolean ramDualChannel, String pcieVersion, int m2Slots, String m2PcieVersion, String videoPorts, int sataPorts, String lan, String wifi, String audioChipset, boolean rgbHeader, BigDecimal price, String currency, boolean stockAvailable, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
        this.id = id;
        this.brand = brand;
        this.model = model;
        this.socket = socket;
