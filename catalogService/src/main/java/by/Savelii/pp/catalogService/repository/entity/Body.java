...
@Entity
@Table(name = "body", uniqueConstraints = @UniqueConstraint(columnNames = {"brand", "model"}))
public class Body {
@Id
...
private OffsetDateTime updatedAt;
    ...
    public Body(Long id, String brand, String model, String formFactor, int maxGpuLength, int maxCpuCoolerHeight, int maxPsuLength, int driveBays35, int driveBays25, int expansionSlots, String fanMounts, BigDecimal price, String currency, boolean stockAvailable, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
        this.id = id;
        this.brand = brand;
        this.model = model;
